...
class Ui_guiDlg(object):
    def setupUi(self, guiDlg):
        ...
        guiDlg.resize(400, 400)
        guiDlg.setMinimumSize(QSize(400, 400))
        guiDlg.setMaximumSize(QSize(400, 400))
        ...
        self.cubo6.setGeometry(QRect(330, 250, 50, 50))
        ...
        self.cubo4.setGeometry(QRect(210, 250, 50, 50))
        ...
        self.cubo1.setGeometry(QRect(30, 250, 50, 50))
        ...
        self.cubo5.setGeometry(QRect(270, 250, 50, 50))
        ...
        self.cubo2.setGeometry(QRect(90, 250, 50, 50))
        ...
        self.cubo3.setGeometry(QRect(150, 250, 50, 50))
    ...
    def retranslateUi(self, guiDlg):
        ...
        self.generar.setText(QCoreApplication.translate("guiDlg", u"PLANIFICAR", None))
