...
class DeviceConnection:
    ...
    @staticmethod
    def createTcpConnectionExplicit(ip, user, psw): 
        """
        returns RouterClient required to create services and send requests to device or sub-devices,
        """

        return DeviceConnection(ip, port=DeviceConnection.TCP_PORT, credentials=(user, psw))
    ...
    def disconect(self, exc_type, exc_value, traceback):
